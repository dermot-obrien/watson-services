...
public class RetrieveEnrichments {
	
	private static Logger logger = Logger.getLogger(RetrieveEnrichments.class.getName());
	
	static final String EnrichmentsFilename = "data/reports/ControlledDocumentsEnrichments.json";
